...
\begin{definition}\label{def:bo}
  ...
  The set of such conatraints is written as $\bodenotations{C.m}$.
\end{definition}
%
...
\begin{definition}[Definite Boundedness Analysis]\label{def:definite_boundness}
  ...
  from the context. That figure uses a frame condition constraint $U$ (for \emph{unchanged})
  that states that all paths keep their value, if they survive the command. For instance, for
  the command $\assign{v}{\exp}$, it is $U=\{\pi'=\pi\mid\pi\survives{\assign{v}{\exp}}\}$.
  %
  \begin{figure}[t]
    \begin{align*}
      \bo{}{\assign{v}{\new{\<List>}{}}}&=\{v'=0\}\cup U\\
      ...
      \pair{\exp}{\dastates{}@(\assign{v}{\exp})}\da{}\pair{\sigma'}{S}\\
      \pi\in S
      \end{array}\right.\right\}\cup U
    \end{align*}
    \caption{The definite boundness analysis of the commands.}
