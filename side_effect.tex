...
\begin{definition}[Side-Effects Analysis]\label{def:side_effect}
  The set of element types of the already existing lists potentially modified during the
  execution of a command $\com$ is overapproximated by $\sideeffect{C.m}{\com}$,
  where $C.m$ is dropped when clear from the context.
  It is defined in Fig.~\ref{fig:side_effect}, by using an \emph{interpretation} $I$ that
  ...
  \end{align*}
  \caption{The side-effect analysis. It uses an interpretation $I$ for constructors and methods.}
