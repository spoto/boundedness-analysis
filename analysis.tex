...
\begin{definition}[Expressions and Commands]\label{def:exp_com}
  ...
  \begin{align*}
    ...
    &\mid\ife{\exp}{\com}{\com}\mid\for{\mathit{v}}{\exp}
  \end{align*}
\end{definition}
...
\begin{definition}[Program]\label{def:program}
  ...
  some \emph{fields}, of the form $C.f$,
  and some \emph{methods}, given as
  a map from method signatures $C.m(p_1 t_1,\ldots,p_n t_n)$ to commands
  (Def.~\ref{def:exp_com}). A class that extends \<Contract>
...
usual meaning as, for instance, in Java or Solidity.
