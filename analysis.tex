...
\begin{definition}[Expressions and Commands]\label{def:exp_com}
  ...
  \begin{align*}
    ...
    &\mid\ife{v}{v}{\com}{\com}\mid\for{\mathit{v}}{v}{\com}\mid\sequence{\com}{\com}.
  \end{align*}
\end{definition}
...
\begin{definition}[Program]\label{def:program}
  ...
  We assume that programs are type-checked and in single assignment form\ie local variables are never reassigned
...
Given an expression or command in a program, it is possible to identify
which lists might be affected by the evaluation of the expression
...
\begin{definition}[Side-Effects Analysis]\label{def:side_effect}
  ...
  It is defined as the minimal solution of the recursive equations in Fig.~\ref{fig:side_effect}.
  %
  \begin{figure}[t]
  \begin{align*}
    \sideeffect{C.m}{\new{C'}{v^*}}&=\sideeffect{C'.C'}{\com}\\
    \noalign{\centering\text{where $\com$ is the body of the constructor $C'.C'$ called here}}
    \sideeffect{C.m}{\exp}&=\varnothing\\
    \noalign{\centering for all other expressions}
  \end{align*}
  \begin{align*}
    \sideeffect{C.m}{\assign{\mathit{v}}{\exp}}&=\sideeffect{C.m}{\exp}\\
    \sideeffect{C.m}{\assign{\field{v}{f}}{v}}&=\sideeffect{C.m}{\aop{v}{v}}=\sideeffect{C.m}{\readmap{v}{v}{v}}=\varnothing\\
    \sideeffect{C.m}{\require{v}{v}}&=\varnothing\\
    \sideeffect{C.m}{\push{v_1}{v_2}}&=\{t\mid\tau_{C.m}(v_1)=\<List<>t\<\text{>}>\}\\
    \sideeffect{C.m}{\receive{v}{v}}&=\varnothing\\
    \sideeffect{C.m}{\call{v}{m'}{v^*}}&=\cup_{j=1}^k\sideeffect{C_j.m'}{\com_j}\\
    \noalign{\centering\text{where $\com_1\cdots\com_k$ are the bodies of methods $C_1.m'\cdots C_k.m'$ possibly called here}}
    \sideeffect{C.m}{\ifetwo{v}{v}{\com_1}{\com_2}}&=\sideeffect{C.m}{\com_1}\cup\sideeffect{C.m}{\com_2}\\
    \sideeffect{C.m}{\for{v}{v}{\com}}&=\sideeffect{C.m}{\com}\\
    \sideeffect{C.m}{\sequence{\com_1}{\com_2}}&=\sideeffect{C.m}{\com_1}\cup\sideeffect{C.m}{\com_2}
  \end{align*}
  \caption{The side-effect analysis.}
...
definition is simplified by the hypothesis that ocal variables are not reassigned
...
%
  \begin{figure}[t]
    \begin{align*}
      ...
      \da{}{\field{v}{f}}(\sigma)&=\pair{\sigma}{\{\pi.f\mid\pi\in\sigma(v)\}\cap\paths{}}\\
      \da{}{\aop{v_1}{v_2}}(\sigma)&=\pair{\sigma}{\{\aop{c_1}{c_2}\mid c_1\in\sigma(v_1),\ c_2\in\sigma(v_2)\}\cap\paths{}}\\
      \da{}{\readmap{v_1}{v_2}{v_3}}(\sigma)&=\pair{\sigma}{\varnothing}\\
      \da{}{\new{C'}{v^*}}(\sigma)&=\pair{\sigma\survives{\new{C'}{v^*}}}{\varnothing}\\
      \da{}{\size{v}}(\sigma)&=\pair{\sigma}{\varnothing}\\
      \da{}{\last{v}}(\sigma)&=\pair{\sigma}{\{\pi\<[any]>\mid\pi\in\sigma(v)\}\cap\paths{}}\\
      \da{}{\random{v}}(\sigma)&=\pair{\sigma}{\varnothing}
    \end{align*}
...
%
  \begin{figure}[t]
    \begin{align*}
      ...
      \da{}{\assign{\field{v}{f}}{v}}(\sigma)&=\sigma\\
      \da{}{\writemap{v}{v}{v}}(\sigma)&=\sigma\\
      \da{}{\require{v}{v}}(\sigma)&=\sigma\\
      \da{}{\push{v_1}{v_2}}(\sigma)&=\sigma''\\
      \noalign{\centering where $\sigma'=\sigma\survives{\push{v_1}{v_2}}$ and $\sigma''=\sigma'[v\mapsto\sigma'(v)\cup(\{\pi\<[any]>\mid\pi\in\sigma'(v_1)\}\cap\paths{})
          \mid\forall v\in\sigma(v_2)]$}
      \da{}{\receive{v}{v}}(\sigma)&=\sigma\\
      \da{}{\call{v}{m}{v^*}}(\sigma)&=\sigma\survives{\mathit{\call{v}{m}{v^*}}}\\
      \da{}{\ifetwo{v}{v}{\com_1}{\com_2}}(\sigma)&=\da{}{\com_1}(\sigma)\cap\da{}{\com_2}(\sigma)\\
      \da{}{\for{v_1}{v_2}{\com}}(\sigma)&=\lfp(\lambda\sigma'.\sigma\cap\da{}{\com}(\sigma'[v_1\mapsto\{\pi\<[any]>\mid\pi\in\sigma'(v_2)\}\cap\paths{}]))(\sigma)\\
