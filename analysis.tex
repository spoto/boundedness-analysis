...
\begin{definition}[Expressions]\label{def:expressions}
  Expressions and commands are defined by the following grammar:
  \begin{align*}
    \exp::=&\ \mathit{c}\mid\mathit{v}\mid\field{\exp}{f}\mid\op{\exp}{\exp}\mid\readmap{\exp}{\exp}{\exp}\\
    &\mid\new{C}{\exp^*}\mid\newlist{}\mid\size{\exp}\mid\last{\exp}\mid\random{\exp}\\
