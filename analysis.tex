...
\begin{definition}[Paths]\label{def:path}
  ...
  \end{itemize}
  A path is \emph{$\kappa$-relevant} if its type is \<List<$t$\texttt{>}> and its depth
...
The $\kappa$ limit on relevant paths will be essential to define a finitely computable
boundedness analysis, as shown later. For simplicity, in the following examples,
