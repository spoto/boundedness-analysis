...
\newcommand{\da}[1]{\vdash_{\mathbb{DA}_{{#1}}}}
\newcommand{\bodenotations}[1]{\mathsf{BO}_{{#1}}}
\newcommand{\bo}[2]{\mathbb{BO}_{{#1}}\left\llbracket{{#2}}\right\rrbracket}
...
\newcommand{\sideeffect}[2]{\mathsf{se}_{{#1}}\left({#2}\right)}
...
\begin{frontmatter}
  ...
  \title{Boundedness Analysis for Smart Contracts}
