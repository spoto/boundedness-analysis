...
\newcommand{\require}[1]{\mathtt{require(}{#1}\mathtt{)}}
\newcommand{\assign}[2]{{#1}\mathtt{:=}{#2}}
\newcommand{\ife}[3]{\mathtt{if\ (}{#1}\mathtt{)\ then\ }{#2}\mathtt{\ else\ }{#3}}
\newcommand{\for}[2]{\mathtt{for\ }{#1}\mathtt{\ in\ }{#2}}
\newcommand{\sequence}[2]{{#1}\mathtt{;}{#2}}
\newcommand{\daa}[1]{\mathbb{DAA}\llbracket{#1}\rrbracket}
...
\newcommand{\sideeffect}[1]{\mathsf{se(}{#1}\mathsf{)}}
\newcommand{\at}[1]{@{#1}}
